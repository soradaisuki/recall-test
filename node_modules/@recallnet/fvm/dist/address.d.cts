import { P as ProtocolIndicator, N as NetworkPrefix } from './address-BWW2x05a.cjs';
...
declare abstract class Address {
     ...
     */
    protected constructor(protocol: ProtocolIndicator, networkPrefix: NetworkPrefix);
    /**
     ...
     * @returns a new instance of a particular address type.
     */
    static fromBytes: (address: Uint8Array, networkPrefix?: NetworkPrefix) => Address;
    /**
     ...
     * @returns a new instance of a particular address type.
     */
    static fromEthAddress: (ethAddr: Uint8Array | string, networkPrefix?: NetworkPrefix) => AddressId | FilEthAddress;
    /**
 ...
 */
declare class AddressBls extends Address {
    /**
     ...
     * @param networkPrefix - indicates which network the address belongs.
     */
    constructor(payload: Uint8Array, networkPrefix?: NetworkPrefix);
    /**
     ...
     * @returns a new instance of AddressBls
     */
    static fromBytes(bytes: Uint8Array, networkPrefix?: NetworkPrefix): AddressBls;
}
/**
 ...
 */
declare class AddressId extends Address {
    /**
     ...
     * @param networkPrefix - indicates which network the address belongs.
     */
    constructor(payload: string | Uint8Array, networkPrefix?: NetworkPrefix);
    /**
     * Allows to get the bytes format of this address
     ...
     * @returns a new instance of AddressId
     */
    static fromBytes(bytes: Uint8Array, networkPrefix?: NetworkPrefix): AddressId;
    /**
 ...
 */
declare class AddressSecp256k1 extends Address {
    /**
     ...
     * @returns a new instance of AddressSecp256k1
     */
    static fromBytes(bytes: Uint8Array, networkPrefix?: NetworkPrefix): AddressSecp256k1;
}
/**
 ...
 */
declare class AddressActor extends Address {
    /**
     ...
     * @returns a new instance of AddressActor
     */
    static fromBytes(bytes: Uint8Array, networkPrefix?: NetworkPrefix): AddressActor;
}
/**
 ...
 */
declare class AddressDelegated extends Address {
    /**
     ...
     * @param networkPrefix - indicates which network the address belongs.
     */
    constructor(namespace: string, subAddress: Uint8Array, networkPrefix?: NetworkPrefix);
    /**
     ...
     * @returns a new instance of AddressDelegated
     */
    static fromBytes(bytes: Uint8Array, networkPrefix?: NetworkPrefix): AddressDelegated;
}
/**
 ...
 */
declare class FilEthAddress extends AddressDelegated {
    /**
     * Allows to create a new instance of EthereumAddress
     * @param ethAddress - valid ethereum address to wrap (as buffer)
     * @param networkPrefix - indicates which network the address belongs.
     */
    constructor(ethAddress: Uint8Array, networkPrefix?: NetworkPrefix);
    /**
     ...
     */
    static fromBytes(bytesFilAddress: Uint8Array, networkPrefix?: NetworkPrefix): FilEthAddress;
    /**
...
export { Address, AddressActor, AddressBls, AddressDelegated, AddressId, AddressSecp256k1, FilEthAddress };

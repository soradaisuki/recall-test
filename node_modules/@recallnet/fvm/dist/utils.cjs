...
__export(utils_exports, {
  base32: () => base32_exports,
  bigintToUint8Array: () => bigintToUint8Array,
  cbor: () => cbor_exports,
  leb128: () => leb128_exports,
  toBigInt: () => toBigInt
});
...
function decode2(data) {
  if (typeof data === "string") {
    if (data.startsWith("0x")) {
      ...
      data = (0, import_from_string.fromString)(hex, "hex");
    } else {
      data = (0, import_from_string.fromString)(data, "hex");
    }
  }
  return (0, import_cborg.decode)(data);
}
...
function bigintToUint8Array(value, pad = false) {
  ...
  if (pad) hex = `00${hex}`;
  return (0, import_from_string2.fromString)(hex, "hex");
}
